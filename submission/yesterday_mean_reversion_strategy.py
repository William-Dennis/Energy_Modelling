"""Mean-reversion baseline using yesterday's realised move."""
...
class YesterdayMeanReversionStrategy(ChallengeStrategy):
    """Fade yesterday's realised price change direction."""
