...
def _make_state(delivery_date: date) -> ChallengeState:
    """Build a minimal ChallengeState for a given delivery date."""
...
class TestDayOfWeekInterface:
    """Strategy satisfies the ChallengeStrategy ABC."""

    def test_is_challenge_strategy(self) -> None:
        assert issubclass(DayOfWeekStrategy, ChallengeStrategy)
