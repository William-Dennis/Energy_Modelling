...
class _AlwaysLong(ChallengeStrategy):
...
class _AlwaysShort(ChallengeStrategy):
    def fit(self, train_data: pd.DataFrame) -> None:
        pass
...
class _PerfectForesight(ChallengeStrategy):
...
class _Skipper(ChallengeStrategy):
    def fit(self, train_data: pd.DataFrame) -> None:
        pass
...
class TestRunMarketEvaluation:
    def test_returns_correct_structure(self) -> None:
        ...
        assert isinstance(result, MarketEvaluationResult)
    ...
    def test_original_results_match_standalone_runner(self) -> None:
        ...
        standalone = run_challenge_backtest(
