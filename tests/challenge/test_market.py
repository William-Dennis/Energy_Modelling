...
class TestRunMarketIteration:
    def test_returns_correct_types(self) -> None:
        ...
        assert isinstance(result, MarketIteration)
...
class TestRunMarketToConvergence:
    def test_converges_with_mixed_strategies(self) -> None:
        ...
        assert isinstance(eq, MarketEquilibrium)
        assert eq.converged
    ...
    def test_dampening_slows_convergence(self) -> None:
        ...
        fast = run_market_to_convergence(**args, dampening=0.9)
        slow = run_market_to_convergence(**args, dampening=0.1)
