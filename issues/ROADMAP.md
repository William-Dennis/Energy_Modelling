...
| 3 | [New Strategies (5-7)](issue_3_new_strategies.md) | High | Large | ⏳ Not started |
...
- **295 tests passing** (excluding `data_collection/` — needs `pytest-mock`)
